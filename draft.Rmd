...
We conclude using paired comparisons that customers who had SEED accounts saw an increase in savings over the duration of the trial. We conclude using Kruskal-Wallis tests that SEED accounts had more savings than the other two groups. Finally, using M-Estimation and rank-based and robust regression we find that SEED accounts had more savings than the other two groups; however, we find much smaller effect sizes than [@Ashraf2006].
