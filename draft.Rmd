...
[@Ashraf2006] implemented a randomized control trial (RCT) to 1. see if individuals offered the account open the accounts, and if so, what characteristics are associated with opening an account and 2. if individuals save more as a result of opening the account. 

The authors partnered with a rural bank in Mindanao, Philippines called Green Bank of Caraga. After two rounds of randomization, they ended up with a survey size of 1,777 people who completed a baseline household survey. They then randomly assigned the individuals to the commitment treatment (T), marketing-treatment (M), and control (C) groups. One concern is that the commitment-savings may have a treatment effect because of the outreach or positive messaging around savings. The marketing treatment (M), a special visit to encourage savings using existing savings products only, was included to evaluate this effect. The marketing-treatment can also be thought of as a control. There were no pre-treatment significant differences between the three groups for observable characteristics.  
...
The authors also estimate quantile regressions at the 10th through 90th deciles. The estimated effects are significant after 12 months when comparing the commitment-saving group with the full control group. The statistical and practical significance disappears when comparing the commitment-savings group with the marketing group. 
