...
The data and code for [@Ashraf2006] are available on the Harvard Dataverse [@Data]. The repository contains Stata `.do` files for all models and tables included in the authors' paper. The repository contains three data sets. 

The first contains information after six months. The second contains information after twelve months. The third data set contains information about the change in balances after six months and twelve months. The authors did not include documentation for the numerous variables included in the data set. We recreated Table II, Table VI, and Table VII in `R` to back out the variable definitions and confirm that the published table matches the published table. 

todo(aaron): include a brief visual summary of the data
...
log; however, non-positive values
